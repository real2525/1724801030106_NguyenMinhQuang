...
<head>
  <meta charset="utf-8" />
  <link rel="apple-touch-icon" sizes="76x76" href="{{asset('public/backend/assets/img/icon.png')}}">
...
<body class="off-canvas-sidebar">
  ...
  <div class="wrapper wrapper-full-page">
    <div class="page-header register-page header-filter" filter-color="black" style="background-image: url({{asset('public/backend/assets/img/register.jpg')}}">
      <div class="container">
        <div class="row">
              ...
              <div class="card-body">
                ...
                <div class="row">
                  ...
                  <div class="col-md-5 mr-auto">
                    <form  action="{{URL::to('/login')}}" class="form" method="POST" >
                      @csrf
                      ...
                      <div class="text-center">
                        <button type="submit" class="btn btn-primary btn-round mt-4">Đăng Nhập</button>
                      </div>
                    </form>
                  </div>
                </div>
      ...
      <footer class="footer">
        <div class="container">
          <div class="copyright float-right">
            ...
            <a href="https://www.creative-tim.com/" target="_blank">Quang</a> for a better web.
          </div>
        </div>
      </footer>
    </div>
 <!--   Core JS Files   -->
  ...
  <script async defer src="{{asset('public/backend/buttons.github.io/buttons.js')}}"></script>
  <!-- Chartist JS -->
  ...
  <script src="{{asset('public/backend/assets/js/material-dashboard.minf066.js?v=2.1.0')}}" type="text/javascript"></script>
