...
<div class="col-md-12">
  <form action="{{URL::to('/save-ads')}}" enctype="multipart/form-data" method="post" class="form-horizontal">
    {{csrf_field()}}
    <div class="card">
        <div class="card-header card-header-rose card-header-text">
          <div class="card-text">
            <h4 class="card-title">{{__('Thêm Ads')}}</h4>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-sm-7">
            <div class="form-group">
              <input class="form-control" type="text" id="slug" name="ads_name" placeholder="{{__('Nhập Tên Quảng Cáo')}}" />
            </div>
          </div>
        </div>
        <div class="row">
          ...
          <div class="col-sm-7">
            <div class="form-group">
              <input class="form-control" type="text" name="ads_desc" class="form-control" placeholder="{{__('Nhập Mô Tả Quảng Cáo')}}" />
            </div>
          </div>
        </div>
        <div class="row">
          ...
          <div class="col-sm-7">
            <div class="form-group">
              <input class="form-control" type="text" name="ads_link" class="form-control" placeholder="{{__('Nhập link Quảng Cáo')}}" />
            </div>
          </div>
        </div>
        <div class="row">
      ...
      <div class="">
        <center>
          <button type="submit" class="btn btn-rose" name="add_ads">{{__('Thêm Quảng Cáo')}}</button>
        </center>
    </div>
  </form>
</div>
