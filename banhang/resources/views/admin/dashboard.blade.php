                        ...
                        <div class="row">
                          ...
                          <div class="col-md-4">
                              ...
                              <ol style="color: red">
                                ...
                                <li>
                                    <a style="color: black;font-size: 16px;" href="{{URL::to('bai-viet/'.$p->post_slug)}}">{{$p->post_title}}</a>| <span style="color: red;font-size: 16px;">({{$p->post_views}} view)</span>
                                </li>
                                @endforeach
                              </ol>
                          </div>
                          <div class="col-md-4">
                              ...
                              <ol style="color: red">
                                ...
                                <li>
                                    <a style="color: black;font-size: 16px;" href="{{URL::to('chi-tiet-san-pham/'.$pro->product_slug)}}">{{$pro->product_name}}</a>| <span style="color: red;font-size: 16px;">({{$pro->product_views}} view)</span>
                                </li>
                                @endforeach
                              </ol>
                          </div>
                          ...
                          <div class="col-md-4">
                            <div class="card card-product">
                              <div class="card-header card-header-image" data-header-animation="true">
                                <a href="#pablo">
                                  <img class="img" height="200" width="300" src="{{asset('public/upload/post/'.$new->post_image)}}" alt="{{$new->post_slug}}">
                                </a>
                              </div>
                              <div class="card-body">
                                <div class="card-actions text-center">
                                  ...
                                  <a type="button" href="{{URL::to('bai-viet/'.$new->post_slug)}}" class="btn btn-default btn-link" rel="tooltip" data-placement="bottom" title="Xem">
                                    <i class="material-icons">art_track</i>
                                  </a>
                                  <a type="button" href="{{URL::to('/edit-post/'.$new->post_id)}}" class="btn btn-success btn-link" rel="tooltip" data-placement="bottom" title="Sửa">
                                    <i class="material-icons">edit</i>
                                  </a>
                                  <a type="button" href="{{URL::to('/delete-post/'.$new->post_id)}}" class="btn btn-danger btn-link" rel="tooltip" data-placement="bottom" title="Xóa">
