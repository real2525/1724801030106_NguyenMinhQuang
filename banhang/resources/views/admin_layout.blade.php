...
<body class="">
  ...
  <div class="wrapper ">
    <div class="sidebar" data-color="rose" data-background-color="black" data-image="{{asset('public/backend/assets/img/sidebar-1.jpg')}}">
      <!--
      ...
      <div class="logo">
        ...
        <a href="{{URL::to('/dashboard')}}" class="simple-text logo-normal">
          Fresh Fruit <img src="{{asset('public/backend/assets/img/icon.png')}}" sizes="70x70">
        </a>
      ...
      <div class="sidebar-wrapper">
        <div class="user">
          <div class="photo">
            <img src="{{asset('public/backend/assets/img/faces/avatar.jpg')}}" />
          </div>
          <div class="user-info">
